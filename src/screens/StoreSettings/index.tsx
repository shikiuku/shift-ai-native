        ...
        <ScrollView style={styles.container} contentContainerStyle={styles.content}>
            <View style={styles.card}>
                ...
                <View style={styles.list}>
                    {店舗スケジュール.map((s, sIdx) => (
                        <View key={s.曜日} style={styles.row}>
                            <Text style={styles.dayLabel}>{s.曜日}</Text>
                            ...
                            <View style={styles.inputsContainer}>
                                <View style={styles.timeInputGroup}>
                                    ...
                                    <TextInput
                                        ...
                                        value={s.営業時間帯[0].開始.toString()}
                                        onChangeText={val => {
                                            const 新 = [...店舗スケジュール];
                                            新[sIdx].営業時間帯[0].開始 = parseInt(val) || 0;
                                            set店舗スケジュール(新);
                                        }}
                                    ...
                                    <TextInput
                                        keyboardType="numeric"
                                        value={s.営業時間帯[0].終了.toString()}
                                        onChangeText={val => {
                                            const 新 = [...店舗スケジュール];
                                            新[sIdx].営業時間帯[0].終了 = parseInt(val) || 0;
                                            set店舗スケジュール(新);
                                        }}
                                        style={styles.timeInput}
                                    />
                                ...
                                <View style={styles.countInputGroup}>
                                    ...
                                    <TextInput
                                        keyboardType="numeric"
                                        value={s.営業時間帯[0].最小人数.toString()}
                                        onChangeText={val => {
                                            const 新 = [...店舗スケジュール];
                                            新[sIdx].営業時間帯[0].最小人数 = parseInt(val) || 0;
                                            set店舗スケジュール(新);
                                        }}
                                    ...
                                    <TextInput
                                        keyboardType="numeric"
                                        value={s.営業時間帯[0].最大人数.toString()}
                                        onChangeText={val => {
                                            const 新 = [...店舗スケジュール];
                                            新[sIdx].営業時間帯[0].最大人数 = parseInt(val) || 0;
                                            set店舗スケジュール(新);
                                        }}
                                        style={styles.countInput}
                                    />
